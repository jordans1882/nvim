...
if dein#tap('vim-clap')
  let g:clap_layout = {'width': '100%', 'height': '25%', 'row': '75%', 'col': '0%'}
	...
	nnoremap <silent>/ :<C-u>Clap! lines<CR>
...
if dein#tap('dashboard-nvim')
  let g:dashboard_custom_header = [
			...
			\' |  \/  (_)___  ___| ____|_ __ |  _  | | __ _  ___ ___  ', 
			\' | |\/| | / __|/ _ \  _| |  _  | |_) | |/ _` |/ __/ _ \ ',
			\' | |  | | \__ \  __/ |___| | | |  __/| | (_| | (_|  __/ ',
			\' |_|  |_|_|___/\___|_____|_| |_|_|   |_|\__,_|\___\___| ',
			\'                                                        ', 
			\ '',
			\ ]
endif
